...
import Littlewood.OmegaLowerBound
...
theorem RH_from_littlewood (hL : Littlewood.LittlewoodOmegaLowerBound_OPEN) : ¬GrowthBound :=
  Littlewood.littlewood_closes_growthbound hL
